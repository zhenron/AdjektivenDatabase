 ...
 *
 ...
 run-as com.xingke.adjektivendatabase
 cp /data/data/com.your.pacakagename/
 cd /data/data/com.xingke.sqlite_codepath
 */
...
public class TodoItemDatabase extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "AdjektivDatabase";

    // Todo table name
    private static final String TABLE_TODO = "AdjektivenItems";
    ...
    public void addTodoItem(TodoItem item) {
        ...
        values.put(KEY_ADJEKTIV,item.getAdjektiv());
        // Insert Row
    ...
    public int getItemCount(){
        SQLiteDatabase db = this.getReadableDatabase();
        int numRows = (int)DatabaseUtils.longForQuery(db, "SELECT COUNT(*) FROM " + TABLE_TODO, null);
        return numRows;
    }
